...
- [x] 5. Implement backend tool functions (services/tools.py)
  - [x] 5.1 Implement search_orders tool
  ...
  - [x] 5.2 Implement check_policy tool
  ...
  - [x] 5.3 Implement initiate_return tool
  ...
  - [x] 5.4 Implement verify_damage_photo tool
...
- [x] 6. Implement Gemini API integration and agent orchestration loop
  - [x] 6.1 Create orchestrator.py service for Gemini tool-use orchestration
    - Implement async call_llm() function with proper headers and API key
    ...
    - Loop up to 6 iterations calling Gemini API
    - Extract tool_use blocks from Gemini response
  ...
  - [x] 6.2 Implement Gemini API error handling
...
- [x] 7. Implement notification service integration
  - [x] 7.1 Create notifications.py service
  ...
  - [x] 7.2 Add notification triggers for return lifecycle events
...
- [x] 9. Implement backend API endpoints (routers)
  - [x] 9.1 Create agent router (routers/agent.py)
  ...
  - [x] 9.3 Create policy router (routers/policy.py)
  ...
  - [x] 9.4 Create returns router (routers/returns.py)
  ...
  - [x] 9.5 Create dashboard router (routers/dashboard.py)
...
- [x] 10. Implement Supabase Storage integration for photo uploads
  - [x] 10.1 Create storage service for photo uploads
  ...
  - [x] 10.2 Integrate photo upload with verify-photo endpoint
    - Accept multipart/form-data with return_id, photo, claimed_issue
    - Upload photo to Supabase Storage
    - Convert photo to base64 for Gemini API
    - Pass base64 image to Gemini for AI analysis
    - Store photo URL and AI verdict in return_evidence table
    - _Requirements: 6.1, 6.2, 6.5, 6.6_

- [x] 11. Implement Pydantic schemas for request/response validation
  - [x] 11.1 Create schemas.py with all request/response models
...
- [x] 13. Create frontend API client module
  - [x] 13.1 Create api.js with API client functions
...
- [x] 14. Migrate frontend to use backend API
  - [x] 14.1 Replace direct Claude API calls in App.jsx
  ...
  - [x] 14.2 Update photo upload to use backend endpoint
  ...
  - [x] 14.3 Update dashboard to fetch data from backend
  ...
  - [x] 14.4 Update error handling and loading states
...
- [x] 15. Preserve UI components and styling
  - [x] 15.1 Verify all UI components remain unchanged
...
- [x] 16. Configure environment variables for deployment
  - [x] 16.1 Create backend .env file with production variables
    - Add DATABASE_URL for Supabase PostgreSQL connection
    - Add GOOGLE_API_KEY for Gemini API
  ...
  - [x] 16.2 Create frontend .env file with production variables
    - Add VITE_API_BASE_URL for backend API endpoint
    - _Requirements: 15.6_

- [x] 17. Create deployment configuration files
  - [x] 17.1 Create Vercel configuration for frontend
  ...
  - [x] 17.2 Create Render configuration for backend
